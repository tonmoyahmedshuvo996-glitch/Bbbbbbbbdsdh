  ...
  try {
    ...
    if (matched) {
      ...
      if (!arr) {
        const replies = [
          "Yes 😘, i am here ",
          "ফ্রেন্ড রিকোয়েস্ট পাঠালে ৫ টাকা দিবো😐",
          "ফ্রেন্ড রিকোয়েস্ট পাঠালে ১ টাকা দিবো🫤",
          "রাহাদ বস তোমাকে ভালোবাসে তাও তুমি মূল্য দিলা না🥹",
           "আবাল তুই এইটা কী করলি🤦",
           "মুই তোমার হাতটা একটু ধরতে পারি",
           "তোর আইডিতে ফ্রেন্ড রিকোয়েস্ট যায় না কেন🤦",
            "আজকে বট দেখে হুদাই ডাকছো মানুষ হলে কী ডাকতে🙁😓???"
        ];
